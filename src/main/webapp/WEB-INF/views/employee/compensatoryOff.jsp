...
<html>
	<head>
		...
		<title><fmt:message key="application-name" /> | Compensatory Off</title>
		...
		<script src="../scripts/jquery-1.8.3.js"></script>
  		...
  		<script src="../scripts/employee/validations.js"></script>
	...
	<body onload = "checkIfErrors(${q}); setDates('${newApplication.fromDate}', '${newApplication.toDate}')">
		...
		<jsp:include page="../shared/leftMenu.jsp" >
			...
			<jsp:param value="Comp Off" name="activeMenuItem"/>
		...
		<div id = 'pageContent'>
			...
			<div id = 'mainContent'>
				...
				<div id = 'newApplicationArea'>
					<form:form name = "applicationForm" 
								modelAttribute="newApplication" 
								method="POST" action="compensatoryOff" 
						...
						<form:errors id = 'errorDiv' path="*" element = "div"></form:errors>
				   		<div id = 'date'>
					        ...
					        <%-- <form:errors class = 'errorSpan' path="fromDate"></form:errors> --%>		 
					        
					        <form:label path="toDate">To</form:label>
				        	<form:input path="toDate" id = "datePicker2" readonly="true"/>			   		
				   			<%-- <form:errors class = 'errorSpan' path="toDate"></form:errors> --%>
			    		</div>
				...
				<div id = 'compOffApplicationListApplicationsList'>
					...
					<c:forEach items = "${applicationsList}" var = "application">
						...
						<div class = 'tableRow'>
   						...
   						<%-- 	<span class = 'toDate'>${application.toDate}</span> --%>
   							...
   							<c:choose>
	   							<c:when test="${application.applicationStatus == 'Pending'}">
	   								<span class = 'delete'><a href='deleteApplication?id=${application.id}&redirect=C' onclick = 'return confirm("Confirm Delete?")'><img src = '../images/delete.jpg' height = 20 title = 'Delete' /></a></span>
	   							</c:when>
	   							<c:otherwise>
	   								<span class = 'delete'>&nbsp;</span>
	   							</c:otherwise>
