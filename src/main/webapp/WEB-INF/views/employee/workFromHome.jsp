...
<html>
	<head>
		...
		<title><fmt:message key="application-name" /> | Work from home</title>
	...
	<body onload = "checkIfErrors(${q}); setDates('${newApplication.fromDate}', '${newApplication.toDate}')">
		...
		<jsp:include page="../shared/leftMenu.jsp" >
			...
			<jsp:param value="Work from home" name="activeMenuItem"/>
			...
			<div id = 'mainContent'>
				...
				<div id = 'newApplicationArea'>
					<form:form name = "newLeaveApplicationForm" 
								...
								method="POST" action="workFromHome" 
				...
				<div id = 'workFromHomeApplicationsList'>
   						...
   						<%-- 	<span class = 'toDate'>${application.toDate}</span> --%>
   							...
   							<c:choose>
	   							<c:when test="${application.applicationStatus == 'Pending'}">
	   								<span class = 'delete'><a href='deleteApplication?id=${application.id}&redirect=W' onclick = 'return confirm("Confirm Delete?")'><img src = '../images/delete.jpg' height = 20 title = 'Delete' /></a></span>
	   							</c:when>
	   							<c:otherwise>
	   								<span class = 'delete'>&nbsp;</span>
	   							</c:otherwise>
